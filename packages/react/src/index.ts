...
export const DiscordAutomodEmbed = /*@__PURE__*/createReactComponent<JSX.DiscordAutomodEmbed, HTMLDiscordAutomodEmbedElement>('discord-automod-embed');
export const DiscordAutomodEmbedDescription = /*@__PURE__*/createReactComponent<JSX.DiscordAutomodEmbedDescription, HTMLDiscordAutomodEmbedDescriptionElement>('discord-automod-embed-description');
...
export const DiscordEmbedDescription = /*@__PURE__*/createReactComponent<JSX.DiscordEmbedDescription, HTMLDiscordEmbedDescriptionElement>('discord-embed-description');
